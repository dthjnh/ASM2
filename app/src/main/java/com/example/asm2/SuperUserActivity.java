...
public class SuperUserActivity extends AppCompatActivity {
    ...
    if (cursor != null && cursor.getCount() > 0) {
        ...
        report.append("\nDonation Drive Report:\n\n")
                ...
                .append("Blood Type A: ").append(bloodTypeA).append(" Liters\n")
                .append("Blood Type B: ").append(bloodTypeB).append(" Liters\n")
                .append("Blood Type AB: ").append(bloodTypeAB).append(" Liters\n")
                .append("Blood Type O: ").append(bloodTypeO).append(" Liters\n")
